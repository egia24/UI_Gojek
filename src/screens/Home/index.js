...
import { sprite, bill, more, shopping, train, goride, gocar, gofood, gosend} from '../../assets/Images';
  ...
  return (
    <View style={payment.container}>
      ...
      <View style={payment.debit}>
        <Text style={payment.saldo}>Rp20.000</Text>
        <Text style={payment.coin}>100 Coins</Text>
      </View>
